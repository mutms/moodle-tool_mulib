...
final class mod_lti_generator extends mod_base {
     ...
     *     visible?: bool,
     * } $record
     * @return stdClass lti record from DB with extra ->cmid field
     */
    public function create_activity(array $record): stdClass {
        ...
        $moduleinfo->toolurl = $record['toolurl'] ?? '';
        $moduleinfo->typeid = 0;
        $moduleinfo->launchcontainer = 1; // LTI_LAUNCH_CONTAINER_DEFAULT.
