...
/**
 * SCORM activity generator.
 *
 * @package    tool_mulib
 * @copyright  2026 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class mod_scorm_generator extends mod_base {
     ...
     *
     * At this stage creates an empty SCORM — package to be added later.
     *
     * @param array{
     *     course: int|stdClass,
     *     name?: string,
     ...
     *     visible?: bool,
     * } $record
     * @return stdClass scorm record from DB with extra ->cmid field
     */
